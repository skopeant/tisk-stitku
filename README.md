...
The current call number is split on whitespace and each part is printed on a separate line. Each item is a separate HTML print page; label/media size is intentionally left to the printer driver for the first Zebra test.
